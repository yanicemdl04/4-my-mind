...
const questions = [
  ...
  { label: "Nom", name: "nom", type: "text", placeholder: "Ton joli nom ici 😊", required: true },
  { label: "Prénom", name: "prenom", type: "text", placeholder: "Et ton doux prénom...", required: true },
...
const SignInPage = () => {
  ...
  return (
    <div className="container signin-responsive">
      <div className="left">
        ...
        <form className="form" onSubmit={isLastStep ? handleSubmit : handleNext}>
          {currentQuestions.map((q, idx) => (
            <div key={q.name} className="form-group animation" style={{ animationDelay: `${2.2 + idx * 0.1}s` }}>
